        ...
        for (int i = 0; i < field.length; i++) {
            for (int j = 0; j < field[i].length; j++) {
                ...
                if(i == j && i == 0) { // Top-left corner
                    ...
                    if(i == j && i == field.length -1) { // Bottom-right
                        field[i][j] = (((field[i-1][j] < 0) ? 
                                        Math.abs(field[i-1][j]) : 0) +
                                       ((field[i-1][j-1] < 0) ?
                                        Math.abs(field[i-1][j-1]) : 0) + 
                        ...
                        if(j == field[i].length - 1 && i == 0) { // Top-right corner
                            ...
                            if(i == field.length - 1 && j == 0) { // Bottom-left corner
                                field[i][j] = (((field[i-1][j] < 0) ? 
                                                Math.abs(field[i-1][j]) : 0) +
                                               ((field[i-1][j+1] < 0) ?
                                                Math.abs(field[i-1][j+1]) : 0) + 
                                ...
                                if(j == 0) { // Left edge
                                    ...
                                    if(j == field[i].length) { // Right edge
                                        field[i][j] = (((field[i-1][j] < 0) ? 
                                                        Math.abs(field[i-1][j]) : 0) +
                                                       ((field[i-1][j-1] < 0) ?
                                                        Math.abs(field[i-1][j-1]) : 0) + 
